...
# Instead, edit Jeweler::Tasks in /home/bojan/NetBeansProjects/flash_tool/Rakefile, and run the gemspec command
# -*- encoding: utf-8 -*-
...
fonts and parsing data from flash files.}
  ...
  s.files = [
    "MIT-LICENSE",
     ...
     "VERSION",
     "lib/flash_tool.rb",
     "nbproject/configs/1.8.properties",
     "nbproject/configs/1.9.1.properties",
     "nbproject/configs/jruby.properties",
